...
/**
 * ÉVASION NEUCHÂTEL — fondation du site d'activités
 * --------------------------------------------------
...
const T = {
  fr: {
    ...
    heroTitle: "Trouvez votre prochaine échappée autour de Neuchâtel",
  ...
  en: {
    ...
    heroTitle: "Find your next escape around Neuchâtel",
    ...
    <div className="na-root">
      ...
      <header className="na-header">
        <a href="#top" className="na-brand">
          <span className="na-brand-mark">▲</span>
          <span>Évasion <strong>Neuchâtel</strong></span>
        </a>
      ...
      <footer className="na-footer">
        <span className="na-brand"><span className="na-brand-mark">▲</span> Évasion <strong>Neuchâtel</strong></span>
...
function Styles() {
  ...
  return (
    <style>{`
      .na-root {
        --lake:#0F4C5C; --lake-deep:#08323D; --stone:#E0A33E; --stone-soft:#F3DCAC;
        --jura:#2F5D3F; --paper:#FBFAF5; --ink:#16242A; --muted:#5C6B70; --line:#E7E2D6;
      ...
      .na-hero-sub{font-size:clamp(1rem,2.2vw,1.22rem); color:#D7E4E7; max-width:560px; margin-bottom:1.8rem;}
      ...
      .na-btn-stone:hover{background:#ECB75A;}
      ...
      .na-tone-water{background:linear-gradient(135deg,#0F4C5C,#1B7C8C);}
      .na-tone-forest{background:linear-gradient(135deg,#2F5D3F,#4C8559);}
      .na-tone-snow{background:linear-gradient(135deg,#3E6E7C,#8FB8C2);}
